...
class UserController extends Controller{
    ...
    function admin_cancel_reason(UserCancelReasonModel $model,$page=1,$limit=20){
        
        $this->L->adminPermissionCheck(157);

        $name = '取消理由';
        # 允许操作接口
        $opt = 
            [
                'get'   => '../user/admin_cancel_reason_get',
                'view'  => 'home/upd',
                'add'   => 'home/upd',
                'del'   => '../user/admin_cancel_reason_del',
            ];
    ...
    function admin_cancel_reason_get(UserCancelReasonModel $model,$id){
        ...
        [
            'get'   => '../user/admin_cancel_reason_get',
            'upd'   => '../user/admin_cancel_reason_upd',
            'back'  => 'user/cancel_reason',
            'view'  => 'home/upd',
    ...
    function admin_cancel_reason_upd(UserCancelReasonModel $model,$id){
        $this->L->adminPermissionCheck(157);
        !$model->field && AJAX::error('字段没有公有化！');
    ...
    function admin_cancel_reason_del(UserCancelReasonModel $model,$id){
        $this->L->adminPermissionCheck(157);
