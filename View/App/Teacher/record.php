...
<div class="layout">
    <div class="album">
        <h1>相册<span>album</span><a href="album.html"></a></h1>
...
//                    var liuyan = result.comment
                    var liuyan = '<textarea readonly id="liuyan">'+result.comment+'</textarea>'
...
//                    没有记录的情况下，编写信息
                    if(result.comment==undefined){
                        ...
                        var writeliuyan = '<textarea id="writeliuyan"></textarea>'
