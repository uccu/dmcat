...
<div class="usTab voteclassify">
    <div class="vote-tab active">
        <a href="javascript:void (0)" >全部投票<span>all active</span></a>
    </div>
    <div class="vote-tab">
        <a href="javascript:void (0)">我的投票<span>my active</span></a>
    </div>
