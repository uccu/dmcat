<style>
    .footer-body a{width:auto}
    </style><div class="index-bottom">
    <div class="w-1200">
        ...
        <div class="footer-body" style="float: right; width: 225px;">
            <span class="phone"><?php echo lang('联系电话');?>：</span>
            <span class="phone-no" style="font-size: 12px;line-height: 16px;">上海 021-68816202<br>
                                    新疆 0991-7788916</span>
            <h1><?php echo lang('传真');?>：<br>上海 021-68816207<br>
新疆 0991-5811770</h1>
            <h1><?php echo lang('地址');?>：<br>上海总部 中国·上海市浦东新区陆家嘴世纪金融广场<br>
新疆总部  中国·乌鲁木齐市奇台路658号</h1>
        </div>
        <div class="clear"></div>
    </div>
</div>
